...
/* harmony import */ var _node_entry_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node-entry.js */ "./node_modules/rollup/dist/es/shared/node-entry.js");
...
/* harmony import */ var node_fs_promises__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! node:fs/promises */ "node:fs/promises");
...
const picomatch$1 = _node_entry_js__WEBPACK_IMPORTED_MODULE_2__.picomatch;
...
const picomatch = _node_entry_js__WEBPACK_IMPORTED_MODULE_2__.picomatch;
...
const require$$3 = /*@__PURE__*/(0,_node_entry_js__WEBPACK_IMPORTED_MODULE_2__.getAugmentedNamespace)(_node_entry_js__WEBPACK_IMPORTED_MODULE_2__.fseventsImporter);
...
class Task {
    constructor(watcher, options) {
        ...
        this.filter = (0,_node_entry_js__WEBPACK_IMPORTED_MODULE_2__.createFilter)(watchOptions.include, watchOptions.exclude);
    ...
    async run() {
        ...
        let result = null;
        try {
            result = await (0,_node_entry_js__WEBPACK_IMPORTED_MODULE_2__.rollupInternal)(options, this.watcher.emitter);
            if (this.closed) {
                return;
            }
