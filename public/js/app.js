...
function changeQuantity(value) {
  var quantityInput = document.querySelector('.value-quantity');
...
function changeQuantityCart(value) {
  var quantityInput = document.querySelectorAll('.value-quantity-cart');
  quantityInput.forEach(element => {
    var currentQuantity = parseInt(element.value);
...
function checklogin(){
  const id_user = document.querySelector('input[name=id_user]');
  const add_cart = document.querySelector('.chitiet-add-cart');
  const check = document.querySelector('.check');
  add_cart.addEventListener('submit',function () {
    if (id_user.value == null) {
      model = `<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
