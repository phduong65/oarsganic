...
<head>
  ...
  <title>{{$title}}</title>
  <link rel="shortcut icon" type="image/png" href="{{URL::asset('img') }}/logo-active.png" />
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./" class="text-nowrap logo-img">
            <img src="{{URL::asset('img') }}/logo-active.png" width="180" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('products.ManagerProduct')}}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('admin.ManagerUser')}}" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('orders.ManagerOrder')}}" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
